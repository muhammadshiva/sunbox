        ...
        <Stack
          ...
          <Box as={'form'} mt={10}>
            <Stack spacing={4}>
             ...
             {registerError && (
                  <Text mt={2} mb={2}>Incorrect email or password.</Text>
              )}
            <Button
            ...
            <Text mt="3" color={'gray.500'} fontSize={{ base: 'sm', sm: 'md' }}>
              Sudah Punya Akun? <Link color="pink.400" fontWeight='bold' href="/auth/login">Login Dulu Kuy!</Link></Text>
          </Box>
          form
        </Stack>
      </Container>
